...
?>
    ...
    <nav class="navbar bg-dark" data-bs-theme="dark">
        <div class="container-fluid justify-content-between">
            <div class="form-group">
                ...
                <input class="form-control" type="text" name="workflow_title" placeholder="Write WorkFlow Name...">
            </div>
    ...
    <div class="card text-center pb-5">
        ...
        <button type="button" class="btn btn-light d-block mt-4 m-auto add_plus_action" onclick="acction_post(0,0)" data-id="0" data-bs-toggle="modal" data-bs-target="#addactionModal"><i class="fa fa-plus"></i></button>
        <button type="button" class="btn btn-light d-block mt-4 m-auto add_action" onclick="acction_post(0,0)" data-id="0" id="toggle_actionbtn" data-bs-toggle="modal" data-bs-target="#addactionModal">Add your frist Action</button>
    ...
    <script>
        ...
        $('#save_workflow').click(function(){
            ...
            if(workflow_title){
                ...
                data.append("cmd","create_workflow");
