<?php
	...
	if($digits == 1){
?>
		<Gather action="sendmsg_or_connect_agent.php?cid=<?php echo $cid?>" input="dtmf" timeout="3" numDigits="1">
			<Say>Press 1 to self book an appointment, Please check your messages. if you are calling from a landline you may press * now to talk to a live agent.</Say>
			<Pause length="3"/>
			<Say>Press 1 to self book an appointment, Please check your messages. if you are calling from a landline you may press * now to talk to a live agent.</Say>
			<Pause length="3"/>
			<Say>Press 1 to self book an appointment, Please check your messages. if you are calling from a landline you may press * now to talk to a live agent.</Say>
